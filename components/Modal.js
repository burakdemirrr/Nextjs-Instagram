                        ...
                        >
                            <div>
                                ...
                                <div className='mt-3 text-center sm:mt-5'>
                                    ...
                                    <div className='mt-2'>
                                        <input type="text" ref={captioRef} className='border-none focus:ring-0 w-full text-center '
                                            placeholder='Please Enter A Caption' />
                                    </div>
                                </div>
                            </div>
                            <div className='mt-5 sm:mt-6 flex items-center '>
                                <button  className='flex bg-red-500 text-white p-1 rounded-lg mx-auto cursor-pointer' onClick={uploadPost} disabled={!selectedFile} type='button'>
                                    {
